...
const questData = asInferredKeysWithValue<Message[]>()({
  ...
  // ─── Pietro Conti (captain 5, Genoa port '9') ────────────────────────────
  ...
  // ─── Catalina Erantzo (captain 2, Seville port '2') ──────────────────────
  ...
  // ─── Otto Baynes (captain 3, London port '30') ────────────────────────────
  ...
  // ─── Ali Vezas (captain 6, Istanbul port '3') ─────────────────────────────
  ...
  // ─── Ernst Von Bohr (captain 4, Hamburg port '36') ───────────────────────
